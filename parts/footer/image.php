...
<div class="<?php echo $footer_image_col_width; ?> order-0 mb-8 lg:mb-0 lg:self-center">
    <div class="w-full flex justify-center <?php echo $footer_image_wrapper_padding; ?>">
        ...
        <?php if ( $footer_image ) : ?>
            <img class="<?php echo $footer_image_padding; ?> max-w-full w-[240px] sm:w-[320px] h-auto 2xl:w-full lg:border-r-4 lg:border-white" src="<?php echo esc_url( $footer_image['url'] ); ?>" alt="<?php echo esc_attr( $footer_image['alt'] ); ?>" />
        <?php endif; ?>
    </div>
</div>